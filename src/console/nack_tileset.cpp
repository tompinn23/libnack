...
nack_tileset *nack_tileset::builtin()
{
...
nack_tileset *nack_tileset::load_memory(const void *data, size_t size,
...
nack_tileset *nack_tileset::load(const char *path, int tile_width,
                                        int tile_height,
                                        nack_tileset_layout layout)
{
    long size;
